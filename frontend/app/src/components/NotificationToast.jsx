...
export default function NotificationToast() {
  ...
  return (
    <div className="fixed bottom-28 md:bottom-6 right-4 z-[200] flex flex-col gap-2 items-end">
      {toasts.map(t => (
        <div
          key={t.id}
          className="flex items-start gap-3 bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 rounded-2xl shadow-xl px-4 py-3 max-w-[320px] animate-in slide-in-from-right-5 fade-in duration-300"
        >
          {ICONS[t.style]}
