...
export default function NavBar() {
    ...
    return (
        <aside className="w-full border-b border-slate-800 bg-slate-950 px-4 py-4 text-slate-100 shadow-xl shadow-slate-950/20 lg:fixed lg:left-0 lg:top-0 lg:flex lg:h-screen lg:w-72 lg:flex-col lg:overflow-y-auto xl:w-80 lg:border-b-0 lg:border-r lg:border-r-slate-800/60 lg:pb-4">
