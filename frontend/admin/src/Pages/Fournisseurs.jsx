      ...
      <div className="w-full rounded-2xl border border-slate-200 bg-white shadow-sm">
        <div className="sticky top-0 z-10 flex items-center justify-between border-b border-slate-100 bg-white px-5 py-4">
          <div>
            ...
            <p className="mt-0.5 text-xs text-slate-400">Entreprise ou professionnel qui fournit les Miitchs.</p>
          </div>
    ...
    <div className="space-y-4">
      <Card>
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            <p className="text-[13px] font-bold text-slate-900">Fournisseurs de Miitchs</p>
            <p className="mt-0.5 text-[11px] text-slate-400">Réservés aux Miitchs d’achat groupé — distincts des commanditaires de Miitchs i.</p>
          </div>
