    ...
    <div aria-live="polite" aria-atomic="false" className="pointer-events-none fixed left-3 right-3 top-20 z-[200] flex flex-col items-stretch gap-2 sm:left-auto sm:w-[min(24rem,calc(100vw-2rem))] sm:items-end">
      {toasts.map(t => (
        <div
          ...
          className="pointer-events-auto flex w-full items-start gap-3 rounded-2xl border border-slate-100 bg-white px-4 py-3 shadow-xl animate-in slide-in-from-right-5 fade-in duration-300"
        >
          {ICONS[t.style]}
