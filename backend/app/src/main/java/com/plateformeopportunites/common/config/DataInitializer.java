...
public class DataInitializer implements CommandLineRunner {
    ...
    private void corrigerContraintesSchema() {
        ...
        String[] drop = {
            ...
            "ALTER TABLE opportunites ADD COLUMN IF NOT EXISTS partenaire_reseaux_url VARCHAR(255)",
            "ALTER TABLE opportunites ADD COLUMN IF NOT EXISTS montant_du_partenaire NUMERIC(38,2) DEFAULT 0",
            "ALTER TABLE opportunites ADD COLUMN IF NOT EXISTS montant_paye_partenaire NUMERIC(38,2) DEFAULT 0",
